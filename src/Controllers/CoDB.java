...
public class CoDB {
    ...
    public synchronized void addForBatchInsert(String path,String name, long date,int suppressed)
        ...
        public synchronized void executeBatchInsert()
                throws SQLException {
        ...
        public synchronized void addForBatchUpdate(String path, long date)
                throws SQLException {
        ...
        public synchronized void executeBatchUpdate()
                throws SQLException {
    ...
    public synchronized void addForBatchLastDBUpdate(String system)
            throws SQLException {
    ...
    public synchronized void executeBatchLastDBUpdate()
            throws SQLException {
        if(this.getInsertSize() == 0)
            return;
    ...
    public synchronized void executeBatchLastDBInsert()
            throws SQLException {
        if(this.getInsertSize() == 0)
            return;
    ...
    public synchronized void addForBatchLastDBInsert(String system)
            throws SQLException {
        updateLastDBBatch.setLong(1, System.currentTimeMillis());
        updateLastDBBatch.setString(2, system);
        updateLastDBBatch.addBatch();
        ...
        public synchronized String getFilePathById(int id) throws Exception {
            Statement stmt=null;
            String ret=null;
            stmt = c.createStatement();
        ...
        public synchronized ResultSet getFiles() throws SQLException {
            Statement stmt=null;
            String ret=null;
            stmt = c.createStatement();
        ...
        public synchronized long getLastUpdate(String key)  {
            Statement stmt=null;
            long ret=0;
            try {
                stmt = c.createStatement();
